    ...
    <div className="RequestsContainer">
      ...
      <div className="pageCard StaticsContainer" data-aos="fade-up">
        <div className="CardHeader">
          <h3>{t("Publication Requests")}</h3>
          <div className={classes.ScrollContainer}>
            <div className={classes.SocialScroll}>
              <div
                className={activeSocial == "SnapChat" && classes.Active}
                onClick={() => setActiveSocial("SnapChat")}
              >
                <SnapChat />
              </div>
              <div
                className={activeSocial == "Instagram" && classes.Active}
                onClick={() => setActiveSocial("Instagram")}
              >
                <Instagram />{" "}
              </div>
              <div
                className={activeSocial == "Xapp" && classes.Active}
                onClick={() => setActiveSocial("Xapp")}
              >
                <Xapp />{" "}
              </div>
              <div
                className={activeSocial == "TikTok" && classes.Active}
        ...
        <RequestsTable setModal={setModal} setShow={setShowDeleteModal} setModalData={setModalData} />
        <Modal
          size="md"
          centered
          show={modal}
